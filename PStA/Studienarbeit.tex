...
\begin{document}
	...
	\begin{onehalfspace}
		...
		\lstinputlisting[language=Python, firstline=77,lastline=122,basicstyle=\tiny,caption={Image Analyse (greyscale)},captionpos=b,label={lst:ImgAnalyCode}]{ImageProcessingPrototype.py}
