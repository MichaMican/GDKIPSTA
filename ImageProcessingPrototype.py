...
def cropImageY(imgArr):
    ...
    # blackThresholdTop = np.median(sumTopBot[0][0:round(len(sumTopBot[0]))])
    # blackThresholdBot = np.median(sumTopBot[1][0:round(len(sumTopBot[1]))])
    blackThresholdTop = np.median(sumTopBot[0])
    blackThresholdBot = 0 #np.median(sumTopBot[1])
    ...
    #return imgArr[detectedTopBorder:detectedBotBorder][0:]
